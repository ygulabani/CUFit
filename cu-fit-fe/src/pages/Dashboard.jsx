...
const Dashboard = () => {
    ...
    const userPlan = {
        ...
        targetWeight: "82kg",
        todaysMeals: {
            breakfast: { time: "8:00 AM", items: ["Eggs & Bacon", "Avocado"], calories: 650 },
            lunch: { time: "1:00 PM", items: ["Grilled Chicken", "Spinach Salad"], calories: 750 },
            dinner: { time: "7:00 PM", items: ["Salmon", "Cauliflower Rice"], calories: 600 },
            snacks: { time: "Various", items: ["Protein Shake", "Nuts"], calories: 400 },
        },
        todaysWorkout: [
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: "Activity Level", value: userPlan.activityLevel, icon: "🏋️‍♀️" },
                        { label: "Daily Calories", value: `${userPlan.dailyCalories} kcal`, icon: "🔥" },
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-900 mb-4">Your Fitness Goals</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-semibold text-gray-900">Today's Keto Meals</h2>
                            <span className="text-sm text-green-600 font-medium">
                                {Object.values(userPlan.todaysMeals).reduce((acc, meal) => acc + meal.calories, 0)} kcal total
                            </span>
                        </div>
                        <div className="space-y-4">
                            {Object.entries(userPlan.todaysMeals).map(([meal, data]) => (
                                <div key={meal} className="border-b border-gray-100 pb-4 last:border-0">
                                    ...
                                    <div className="text-sm text-gray-600">{data.items.join(", ")}</div>
                                    <div className="text-sm text-green-600 mt-1">{data.calories} calories</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    {/* Workout Plan */}
                    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                        <h2 className="text-xl font-semibold text-gray-900 mb-4">Today's Strength Training</h2>
                        <div className="divide-y divide-gray-100">
                            {userPlan.todaysWorkout.map((exercise, index) => (
                                <div key={index} className="py-3 first:pt-0 last:pb-0">
                                    ...
                                    <div className="text-sm text-gray-600 mt-1">Weight: {exercise.weight}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                    ...
                    <div className="flex items-center justify-around">
                        <div className="text-center">
                            ...
                            <p className="text-2xl font-bold text-green-600">{userPlan.currentWeight}</p>
                        </div>
                        <div className="text-green-500">→</div>
                        <div className="text-center">
                            <p className="text-sm text-gray-500">Target</p>
                            <p className="text-2xl font-bold text-green-600">{userPlan.targetWeight}</p>
                        </div>
                    </div>
                </div>
            </div>
